    ...
    if (!analytics) {
        return (
            <div className="text-center py-8">
                ...
                <p className="text-gray-500">Belum ada data analitik</p>
            </div>
        );
    }
...
export function JournalWeeklySummaryCard({
    ...
    return (
        <Card className="border-purple-200 dark:border-purple-800 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-900">
            <CardHeader>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {summary.key_themes.map((theme, i) => (
                                <span
                                    key={i}
                                    className="px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-full text-sm"
                                >
                                    {theme}
                                </span>
                            ))}
