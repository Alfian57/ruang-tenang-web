...
export default function JournalCommunityPanel() {
                    ...
                    {journals.map((j) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                {j.mood_label && (
                                    <MoodAssetIcon moodLabel={j.mood_label} size={24} className="h-6 w-6 object-contain" />
                                )}
                            </div>
                        ...
                        <>
                            <DialogHeader>
                                ...
                                <DialogTitle className="mt-3 flex items-center gap-2 text-left text-xl">
                                    {detail.mood_label && <MoodAssetIcon moodLabel={detail.mood_label} size={20} className="h-5 w-5 object-contain" />}
