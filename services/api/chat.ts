...
export const chatService = {
  ...
  moveToTrash(token: string, id: string) {
  ...
  updateFolder(token: string, id: string, data: { name?: string; color?: string; icon?: string }) {
  ...
  moveToFolder(token: string, sessionId: string, folderId: number | null) {
