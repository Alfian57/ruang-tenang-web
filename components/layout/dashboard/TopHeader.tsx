      ...
      <div className="w-full min-w-0 flex items-center justify-between gap-3 xl:gap-4">
        ...
        <div className="flex min-w-0 shrink-0 items-center gap-2 xl:gap-3">
          ...
          {isAdmin ? (
            ...
            <div className="hidden md:flex items-center bg-linear-to-r from-red-50 to-primary/10 border border-red-200 rounded-full px-4 py-1.5 shadow-sm">
              <div className="flex items-center gap-2">
            ...
            <>
              ...
              {hasXPBoost && (
                <div
                  className="hidden md:flex items-center gap-2 rounded-full border border-primary/20 bg-linear-to-r from-primary/10 to-amber-50 px-3 py-1.5 shadow-sm"
                ...
                >
                  ...
                  <span className="text-[11px] text-primary/80 whitespace-nowrap">
              ...
              >
                <MapIcon className="h-3.5 w-3.5 text-primary/80" />
              </button>
            </>
          )}
