...
export default function LeaderboardSection() {
  ...
  useEffect(() => {
    const fetchLeaderboard = async () => {
      try {
        const response = await api.getLeaderboard(3) as { data: LeaderboardUser[] };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto mb-12 items-end">
          ...
          {topThree[1] && (
            ...
            >
              ...
              <p className="text-gray-500 font-medium mb-2">{topThree[1].role}</p>
          ...
          {topThree[2] && (
            ...
            >
              ...
              <p className="text-gray-500 font-medium mb-2">{topThree[2].role}</p>
