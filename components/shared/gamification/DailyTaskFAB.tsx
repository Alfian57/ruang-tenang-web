    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Badge counter */}
          {claimableTasks > 0 && !isOpen && (
            <div className="absolute -top-1 -right-1 w-5 h-5 theme-notification-bg text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow-md border-2 border-white">
              {claimableTasks}
            </div>
          )}
