...
export default function ContactPage() {
  return (
    <div className="public-page">
      ...
      <main className="pt-44 pb-16 sm:pt-48">
        <section className="px-4">
          <div className="container mx-auto max-w-6xl">
            <PublicPageHero eyebrow="Tim Ruang Tenang" title={<>Mari <span>berbincang</span></>} description="Pilih kanal yang sesuai agar tim kami bisa merespons kebutuhan akun personal, billing, maupun implementasi organisasi dengan cepat." pose="message" />
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-center">
              <div>
                ...
                <h2 className="mt-5 max-w-3xl text-3xl font-bold leading-tight text-gray-950 md:text-4xl">
